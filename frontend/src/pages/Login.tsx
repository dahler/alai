    ...
    <div className="min-h-screen bg-dark-bg flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-dark-hover to-purple-600 flex items-center justify-center mx-auto mb-5 shadow-xl shadow-dark-hover/20">
